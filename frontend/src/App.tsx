...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#090d16] text-slate-100 flex flex-col font-sans relative overflow-hidden pb-12">
      ...
      {/* Main Content Body */}
      <main className="w-full max-w-7xl mx-auto px-6 mt-8 flex-1 grid grid-cols-1 lg:grid-cols-12 gap-8 z-10">
        
        {/* Left Column - Submission and Lookups (5 cols) */}
        ...
        <section className="col-span-1 grid grid-cols-1 lg:col-span-12">
          <LiveLogs 
            logs={logs} 
            onClear={clearLogs} 
          />
